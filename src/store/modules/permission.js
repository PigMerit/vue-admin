import { getUserRole } from "@/network/api/login";
    ...
    createRouter({ commit }, data){
        return new Promise((resolve, reject) => {
            ...
            if(role.includes('admin')) {
                ...
                console.log('用户路由权限判断') 
                console.log(asnycRouterMap,role)
                //这样过滤不太行，会改变路由里面子路由的值，下次使用的时候会变化，可以在退出登陆的时候再给动态路重新赋值，暂时解决
